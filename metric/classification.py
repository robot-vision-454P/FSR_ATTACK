...
def attack_mini_batches(predict, adversary, loader, device="cuda", num_batch=None, topk=1):
    ...
    for data, label in loader:
        ...
        adv_logits,attack_logits, adv_logits_r, adv_logits_nr, adv_logits_rec = predict(adv, is_eval=True)
        advpred = predict_from_logits(adv_logits)
        nat_logits,net_logits, nat_logits_r, nat_logits_nr, nat_logits_rec = predict(data, is_eval=True)
